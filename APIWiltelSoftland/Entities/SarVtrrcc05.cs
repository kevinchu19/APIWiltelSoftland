...
namespace APIWiltelSoftland.Entities
{
    ...
    {
        public string SarVtrrcc05Identi { get; set; }
        public int SarVtrrcc05Nroitm { get; set; }
        public string SarVtrrcc05Modcpt { get; set; }
        public string SarVtrrcc05Codcpt { get; set; }
        public string SarVtrrcc05Tipcpt { get; set; }
        public decimal? SarVtrrcc05Import { get; set; }
        public decimal? SarVtrrcc05Impuss { get; set; }
